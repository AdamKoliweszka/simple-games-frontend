...
const usersReducer = createReducer(
  ...
  on(UsersActions.addPointsToFirstUser, (state) => ({
    ...state,
    pointsFirstUser: state.pointsFirstUser + 1,
  })),
  on(UsersActions.addPointsToSecondUser, (state) => ({
    ...state,
    pointsSecondUser: state.pointsSecondUser + 1,
  }))
);
